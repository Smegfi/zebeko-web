...
export default function LandingHero() {
  ...
  // Paralax efekt - pozadí se pohybuje pomaleji než scroll
  // Pouze když je scroll v rámci hero sekce
  const parallaxOffset = scrollY < windowHeight ? scrollY * 0.5 : windowHeight * 0.5;
  const contentOffset = scrollY < windowHeight ? scrollY * 0.2 : windowHeight * 0.2;
  ...
  return (
    ...
    >
      {/* Background Image s paralax efektem */}
      <div className="absolute inset-0">
        ...
        ></div>
        {/* Dark overlay s paralax efektem */}
        <div 
          className="absolute inset-0 bg-gradient-to-br from-neutral-900/80 via-neutral-800/70 to-neutral-900/80"
          style={{
      ...
      {/* Content s paralax efektem - pohybuje se rychleji než pozadí */}
      <div 
